def notifyBuild(String buildStatus, Exception e) {
  ...
  emailext(
      ...
      to: "Igor.Chornobay@osi.ca.gov, Alex.Kuznetsov@osi.ca.gov, Dmytro.Sorych@osi.ca.gov, denys.davydov@osi.ca.gov, oleksii.khilkevych@osi.ca.gov, mykhailo.zemlianyi@osi.ca.gov, Dmytro.Palczewski@osi.ca.gov"
    )
}
...
//	   checkout([$class: 'GitSCM', branches: [[name: '*/case-managemennt-api-dev']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '433ac100-b3c2-4519-b4d6-207c029a103b', url: 'git@github.com:ca-cwds/de-ansible.git']]])
	   checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: '*/tpt4']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: '433ac100-b3c2-4519-b4d6-207c029a103b', url: 'git@github.com:ca-cwds/de-ansible.git']]]
