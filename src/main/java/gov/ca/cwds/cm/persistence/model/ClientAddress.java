 ...
 */
@NamedQuery(
    name = ClientAddress.NQ_FIND_BY_CLIENT_ID,
    query = "FROM ClientAddress WHERE fkClient = :" + ClientAddress.NQ_PARAM_CLIENT_ID
)
@Entity
@Table(name = "CL_ADDRT")
public class ClientAddress extends BaseClientAddress {
  ...
  public static final String NQ_FIND_BY_CLIENT_ID = "gov.ca.cwds.cm.persistence.model.ClientAddress.findByClientId";
