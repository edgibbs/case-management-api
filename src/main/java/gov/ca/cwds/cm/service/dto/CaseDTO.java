...
public class CaseDTO extends BaseDTO implements RequestResponse {
  ...
  @ApiModelProperty(
    required = true,
    value =
        "Code of the county within the state of California to which a specific CASE is assigned",
    example = "1068"
  )
  ...
  @NotNull
  @OneOf(
    value = {"NO_RESTRICTION", "SEALED", "SENSITIVE"},
    ignoreCase = true,
  ...
  @ApiModelProperty(
    required = true,
    value =
        "Security access level code, permitted values are : 'NO_RESTRICTION', 'SEALED', 'SENSITIVE'",
    example = "SEALED"
  )
  ...
  @ApiModelProperty(
    value =
        "Responsible agency code, permitted values are : "
            + "'PRIVATE_ADOPTION_AGENCY', "
            + "'COUNTY_WELFARE_DEPARTMENT', "
            + "'INDIAN_CHILD_WELFARE', "
            + "'KIN_GAP', "
            ...
            + "'PROBATION', "
            + "'STATE_ADOPTION_DISTRICT_OFFICE'",
    example = "PRIVATE_ADOPTION_AGENCY"
  )
