...
public class CaseByStaff extends BaseDTO implements Response {
  ...
  @ApiModelProperty(
      value = "ASSIGNMENT.ID - A system generated number used to uniquely identify each ASSIGNMENT. "
  ...
  @ApiModelProperty(
      value = "ASSIGNMENT.START_DATE - The date that an assignment was made to a STAFF PERSON.",
      example = "2000-12-31"
  )
  ...
  @ApiModelProperty(
      value = "ASSIGNMENT.START_TIME - The time that an assignment was made to a STAFF PERSON.",
      example = "2000-12-31"
  )
  private LocalTime assignmentStartTime;

  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd")
  @ApiModelProperty(
      value = "ASSIGNMENT.END_DATE - The date a STAFF PERSON is no longer assigned responsibility "
          + "to a CASE or REFERRAL in the  particular role that they were fulfilling. "
          + "The End Date is entered upon either completion or transfer of the ASSIGNMENT to "
  ...
  @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "hh:mm:ss")
  @ApiModelProperty(
      value = "ASSIGNMENT.END_TIME - The time that an assignment for a STAFF PERSON ended.",
      example = "2000-12-31"
  )
  private LocalTime assignmentEndTime;
